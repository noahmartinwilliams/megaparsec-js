...
data Expr = AnonFuncExpr [Variable] Statem | FuncCallExpr Expr [Expr] | BinOpExpr Expr Expr BinOp | VarExpr Variable | IntExpr Int | StringLitExpr String | ObjExpr (Map String Expr) deriving(Show, Eq)
